...
if (!function_exists('onepress_fonts_url')) :
	...
	function onepress_fonts_url()
	{
		...
		* into your own language.
		*/
		$roboto_condensed = _x('on', 'Roboto Condensed font: on or off', 'onepress');
		...
		* into your own language.
		*/
		$oswald = _x('on', 'Oswald font: on or off', 'onepress');

		if ('off' !== $raleway || 'off' !== $open_sans || 'off' !== $roboto_condensed) {
			$font_families = array();
