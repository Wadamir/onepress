			...
			<div class="container">
				...
				<div class="header-right-wrapper text-right">
					...
					<div class="menu_wrapper">
						...
						<label for="active-menu" class="menu-btn"><i class="fa fa-bars"></i></label>
...
if (!function_exists('onepress_custom_inline_style')) {
	...
	if (!function_exists('onepress_footer_site_info')) {
		...
		{
			?>
			<?php printf(esc_html__('%1$s %2$s %3$s', 'onepress'), '&copy;', '2006 - ' . esc_attr(date('Y')), esc_attr(get_bloginfo())); ?>
		<?php
		}
	}
